 ...
 (function() { 
      ...
      * @returns {Boolean} 点在矩形内返回true,否则返回false
      */
     GeoUtils.isMarkerInRect = function (marker, bounds) {
         var point = marker.getPosition();
         return GeoUtils.isPointInRect(point, bounds);
     }

     /**
      * 判断marker是否在多边形内
      * @param {Marker} marker 标注点对象
      * @param {Circle} circle 多边形对象
      * @returns {Boolean} 点在圆形内返回true,否则返回false
      */
     GeoUtils.isMarkerInPolygon = function (marker, polygon) {
         var point = marker.getPosition();
      ...
      * @returns {Boolean} 点在圆形内返回true,否则返回false
      */
     GeoUtils.isMarkerInCircle = function (marker, circle) {
         var point = marker.getPosition();
         return GeoUtils.isPointInCircle(point, circle);
     }
