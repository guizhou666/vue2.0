...
var CommandInterceptor__default = /*#__PURE__*/_interopDefaultLegacy(CommandInterceptor);
...
var AssociationIcon = (({
  styles = {},
  ...props
}) => /*#__PURE__*/React__default["default"].createElement("svg", _extends$1o({
  width: "32",
  height: "32",
...
var BusinessRuleTaskIcon = (({
  styles = {},
  ...props
}) => /*#__PURE__*/React__default["default"].createElement("svg", _extends$1n({
  xmlns: "http://www.w3.org/2000/svg",
  width: "32",
  height: "32"
}, props), /*#__PURE__*/React__default["default"].createElement("path", {
...
var EmptyIcon = (({
  ...
  width: "64",
  height: "64"
}, props), /*#__PURE__*/React__default["default"].createElement("defs", null, /*#__PURE__*/React__default["default"].createElement("rect", {
  id: "a",
  width: "57",
  height: "47",
  x: "3",
...
function withVariableContext(Component) {
  return props => {
    ...
    const context = hooks.useMemo(() => {
      const variables = zeebe.getVariablesForElement(bo);
...
function Assignee$1(props) {
  ...
  return withVariableContext(propertiesPanel.FeelEntry)({
    element,
    id: 'assignmentDefinitionAssignee',
...
function ExtensionPropertiesProps({
  ...
  if (namespace === 'zeebe' && !ModelUtil.is(element, 'zeebe:PropertiesHolder')) {
    return [];
  }
...
function addFactory$6({
  ...
  return function (event) {
    ...
    const propertyName = getPropertyName(namespace); // (2) ensure camunda:Properties
    ...
    const property = createElement(`${namespace}:Property`, {}, properties, bpmnFactory); // (4) add property to list
...
function getProperties(element, namespace = 'camunda') {
  return getExtensionElementsList(ModelUtil.getBusinessObject(element), `${namespace}:Properties`)[0];
}
function getPropertiesList(element, namespace = 'camunda') {
  const properties = getProperties(ModelUtil.getBusinessObject(element), namespace);
...
function setPropertyValue(bpmnFactory, commandStack, element, property, value) {
  ...
  if (type === ZEEBE_TASK_HEADER_TYPE) {
    ...
    const values = taskHeaders.get('values').filter(value => value !== oldTaskHeader); // do not persist task headers with empty value
...
class ChangeElementTemplateHandler$1 {
  ...
  _updateZeebePropertyProperties(element, oldTemplate, newTemplate) {
    ...
    let zeebeProperties = findExtension$1(businessObject, 'zeebe:Properties'); // (1) remove old zeebe:Properties if no new zeebe:Property properties
    ...
    newProperties.forEach(newProperty => {
      const oldProperty = findOldProperty$1(oldTemplate, newProperty),
            ...
            newPropertyValue = newProperty.value,
            newBinding = newProperty.binding; // (2) update old zeebe:Property
...
function shouldKeepValue(element, oldProperty, newProperty) {
  ...
  if (newProperty.type === 'Dropdown') {
    const currentValue = getPropertyValue(element, newProperty); // only keep value if old value is a valid option
...
class ElementTemplatesConditionChecker extends CommandInterceptor__default["default"] {
...
class ElementTemplates$1 {
  ...
  getLatest(id, options = {}) {
    return this._getTemplateVerions(id, { ...options,
      latest: true
    });
  }
  /**
...
class Validator$1 {
  ...
  _validateTemplate(template) {
    ...
    if (schemaVersion && semverCompare__default["default"](SUPPORTED_SCHEMA_VERSION$1, schemaVersion) < 0) {
...
class Validator extends Validator$1 {
  ...
  _validateTemplate(template) {
    ...
    if (schemaVersion && semverCompare__default["default"](SUPPORTED_SCHEMA_VERSION, schemaVersion) < 0) {
...
class ReplaceBehavior$1 extends CommandInterceptor__default["default"] {
...
class TemplateElementFactory {
  ...
  create(template) {
    ...
    const {
      properties
    } = applyConditions(element, template); // (5) apply properties
...
function FeelTextAreaProperty(props) {
  ...
  const bpmnFactory = useService('bpmnFactory'),
        ...
        debounce = useService('debounceInput'),
        translate = useService('translate');
  return withVariableContext(propertiesPanel.FeelTextAreaEntry)({
    debounce,
    element,
    getValue: propertyGetter$1(element, property),
    id,
...
var index$1 = {
  __depends__: [commandsModule$1, templateElementFactoryModule, translateModule__default["default"], zeebePropertiesProviderModule],
...
class ReplaceBehavior extends CommandInterceptor__default["default"] {
  constructor(elementTemplates, injector) {
    super(injector.get('eventBus'));
    this.postExecuted('shape.replace', function (e) {
      var context = e.context,
